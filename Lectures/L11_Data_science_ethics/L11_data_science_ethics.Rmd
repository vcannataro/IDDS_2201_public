---
title: "Data science ethics: misrepresentation, privacy, and algorithmic bias"
subtitle: "<br><br> IDDS 2201: Data Analytics, Module 11"
...
# A recent example of stretching the axes... 

```{r, echo=F}
knitr::include_graphics("img/Screenshot from 2022-03-21 11-35-59edit.png")
...
```{r, echo=F}
knitr::include_graphics("img/FKIqqi3WUAYEQhB.png")
```
...
```{r, echo=F}
knitr::include_graphics("img/FKIqtMZXwAgH91t.png")
```
...
## Highly suspect findings 


```{r,echo=F}
knitr::include_graphics("img/JAMA_2018_paper.png")
```
...
knitr::include_graphics("img/NYTimes_420.png")
```
...
```{r, echo=F}
knitr::include_graphics("img/Sci_am_420_1.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("img/deaths_per_day_420_week.png")
```

---

## Taking a further (closer?) look... 

```{r, echo=FALSE}
knitr::include_graphics("img/deaths_per_day_420_year.png")
```

---

## (Data) Science as a self-correcting process

```{r, echo=FALSE}
knitr::include_graphics("img/Sci_am_420_2.png")
```
...
.footnote[
.midi[
Alberto Cairo. [How charts lie talk](https://www.youtube.com/watch?v=Low28hx4wyk).
]
]
...
knitr::include_graphics("img/county_votes_2020.gif")
```
...
.center[
There is software used across the country to predict future criminals.  
